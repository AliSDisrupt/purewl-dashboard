...
export function AssistantMarkdown({ content }: { content: string }) {
  return (
    <div className="atlas-markdown atlas-markdown-root leading-relaxed text-foreground/95">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-primary/40 pl-4 py-1 my-3 bg-muted/30 rounded-r text-muted-foreground italic">
              {children}
            </blockquote>
          ),
          h1: ({ children }) => (
          ...
          code: ({ className, children, ...props }) => {
            ...
            return (
              <code
                className="bg-muted/80 border border-border/50 px-1.5 py-0.5 rounded text-sm font-mono"
                {...props}
              >
                {children}
              </code>
